          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-4xl mx-auto mb-12">
            <Card className="bg-white/80 backdrop-blur-sm shadow-xl border-0">
              <CardContent className="p-6 text-center">
                ...
                <div className="text-gray-600 font-semibold">Memorable Moments</div>
              </CardContent>
            </Card>
            <Card className="bg-white/80 backdrop-blur-sm shadow-xl border-0">
              <CardContent className="p-6 text-center">
                ...
                <div className="text-gray-600 font-semibold">Tournament Victories</div>
              </CardContent>
            </Card>
            <Card className="bg-white/80 backdrop-blur-sm shadow-xl border-0">
              <CardContent className="p-6 text-center">
                ...
                <div className="text-gray-600 font-semibold">Years Documented</div>
              </CardContent>
            </Card>
          </div>
          ...
          <motion.div layout className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            <AnimatePresence>
              {filteredImages.map((image) => (
                ...
                >
                  <Card className="bg-white shadow-xl hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-3 border-0 overflow-hidden">
        ...
        {selectedImage && (
          ...
          >
            ...
            >
              ...
              <Button
                onClick={() => setSelectedImage(null)}
                className="absolute top-4 right-4 bg-white/20 hover:bg-white/30 text-white border-0 rounded-full p-3 backdrop-blur-sm"
                size="sm"
              >
                <X className="w-6 h-6" />
              </Button>
