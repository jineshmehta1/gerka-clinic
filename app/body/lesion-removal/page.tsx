            ...
            <section className="space-y-12">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-start">
                <div className="space-y-6 text-zinc-600 font-light leading-relaxed text-[16px]">
                  ...
                  <p>
                    Lesions are removed for cosmetic reasons following a clinical assessment to confirm their benign nature. For your convenience, you can receive an initial price estimate by <span className="text-zinc-900 font-medium">sending a clear photograph of the lesion via WhatsApp</span>.
                  </p>
                  <div className="p-6 bg-zinc-900 text-white rounded-3xl space-y-2">
                    <p className="text-xs uppercase tracking-widest font-bold text-zinc-400">Periocular Specialist</p>
                    <p className="text-sm font-light">We specialize in removal of lesions on delicate areas, including eyelids and under-eye skin.</p>
                  </div>
                </div>
               ...
               <div className="bg-[#EAEAE6] p-10 rounded-[3rem] space-y-8 flex flex-col justify-center">
                  <div className="space-y-4">
                     ...
                     <p className="text-sm text-zinc-600 font-light leading-relaxed">
                        Removal is quick and performed using medical-grade electrosurgery or precision excision to ensure minimal marking.
                     </p>
                  </div>
               ...
               <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center relative z-10">
                  <div className="space-y-8">
                     <div className="space-y-2">
                        <span className="text-[10px] font-bold uppercase tracking-[0.4em] text-zinc-500">Delicate Areas</span>
                        <h2 className="text-3xl font-light">Eyelid & Periocular Specialist Removal</h2>
                     </div>
                     <p className="text-zinc-400 font-light leading-relaxed">
                        Precision is essential to protect the eye structures. We have extensive experience in removing lesions from these areas with minimal aesthetic disruption.
                     </p>
                     <ul className="grid grid-cols-2 gap-y-3">
                        {["Skin tags", "Xanthelasma", "Papular lesions", "Sebaceous glands"].map(item => (
                  ...
                  <div className="aspect-video rounded-[2rem] overflow-hidden border border-white/10 shadow-lg">
                     <img src="/lesion2.webp" alt="Periocular Specialist Care" className="w-full h-full object-cover" />
                  </div>
               </div>
            </section>
            ...
            <section className="space-y-12">
               ...
               <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                  {benignLesions.map((lesion) => (
                    <div key={lesion.title} className="p-8 bg-white border border-zinc-100 rounded-3xl space-y-4 shadow-sm">
            ...
            <section className="p-10 md:p-16 bg-[#F9F9F7] rounded-[3rem] border border-zinc-100 space-y-10">
               ...
               <div className="grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-6">
                  {[
                    ...
                    "Mandatory clinical assessment prior to all procedures",
                    "Suspicious lesions will be referred for medical evaluation",
                    "Costs vary based on lesion type, size and quantity"
                  ].map((info) => (
