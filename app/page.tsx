    ...
    <section className="py-24 bg-gradient-to-br from-gray-50 to-purple-50/30">
      <div className="max-w-4xl mx-auto px-6">
        ...
        >
          ...
          <p className="text-xl text-gray-600">Everything you need to know about our chess programs</p>
        </motion.div>
                    ...
                    <CardContent className="p-12 text-center">
                      ...
                      <div className="flex items-center justify-center space-x-6">
                        ...
                        <div className="text-left">
                          ...
                          <div className="bg-gradient-to-r from-orange-500 to-red-500 text-white text-sm px-3 py-1 rounded-full inline-block">
                            {review.achievement}
                          </div>
                        </div>
                      </div>
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="relative min-h-screen flex items-center bg-gradient-to-br from-white via-purple-50/30 to-blue-50/30 overflow-hidden pt-32 pb-32">
        ...
        <div className="max-w-7xl mx-auto px-6 grid lg:grid-cols-2 gap-20 items-center relative z-10">
          ...
          >
            ...
            >
              <div className="flex items-start space-x-8">
                ...
                <div className="flex-shrink-0">
                  ...
                  >
                    <svg width="80" height="80" viewBox="0 0 80 80" className="text-gradient">
                      <defs>
                ...
                <div className="space-y-4">
                  <div className="grid grid-cols-2 gap-4">
                    {[
                      ...
                      >
                        ...
                        <div className="text-sm text-gray-600 font-medium">{item.achievement}</div>
                      </motion.div>
                    ))}
                  </div>
                  ...
                  <div className="pt-4 border-t border-gray-200">
                    <p className="text-gray-700 font-semibold mb-2">Taught by</p>
                    ...
                    <p className="text-gray-600 font-medium">Chess Master & Visionary Educator</p>
                  </div>
                </div>
              </div>
            </motion.div>
            ...
            >
              <Button className="bg-gradient-to-r from-orange-500 to-red-500 hover:from-orange-600 hover:to-red-600 text-white text-xl font-bold px-10 py-4 rounded-full shadow-xl hover:shadow-2xl transform hover:scale-105 transition-all duration-300">
                Start Your Chess Journey
              </Button>
              <Button
                variant="outline"
                className="border-2 border-purple-600 text-purple-600 hover:bg-purple-600 hover:text-white text-xl font-bold px-10 py-4 rounded-full bg-transparent transition-all duration-300"
              >
          ...
          >
            <div className="relative rounded-3xl overflow-hidden shadow-2xl bg-black aspect-video">
              ...
              <div className="absolute bottom-8 left-8 right-8 bg-white/95 backdrop-blur-sm rounded-2xl p-6">
                <h3 className="text-2xl font-bold text-gray-800 mb-2">A Message from Grand Master</h3>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              ...
              <motion.div
                ...
                viewport={{ once: true }}
              >
                <Card className="bg-white shadow-xl hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-3 border-0 overflow-hidden group h-full">
                ...
                >
                  ...
                  <CardContent className="p-8">
                    ...
                    <div className="text-center">
                      <div className="text-3xl font-black text-gray-800 mb-4"></div>
                      <Button
      ...
      >
        ...
        >
          <Button className="bg-gradient-to-r from-orange-500 to-red-500 hover:from-orange-600 hover:to-red-600 text-white font-bold px-8 py-4 rounded-full shadow-2xl hover:shadow-3xl">
            Book FREE Demo
          </Button>
        </motion.div>
      </motion.div>
      ...
      {isVideoOpen && (
        ...
        >
          <motion.div
            ...
            animate={{ scale: 1 }}
            exit={{ scale: 0.8 }}
            className="bg-white rounded-2xl p-4 max-w-5xl w-full"
