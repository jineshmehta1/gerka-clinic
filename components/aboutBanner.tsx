...
export function GerkaHeroBanner() {
  // Mapping the specific filenames you provided
    ...
    <section className="relative w-full min-h-[100vh] flex flex-col items-center justify-center overflow-hidden bg-white pt-40 pb-20">
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-6 flex flex-col items-center text-center">
        ...
        <motion.p 
          ...
          className="text-zinc-800 text-lg md:text-xl font-light max-w-2xl leading-relaxed mb-12"
        >
          Ireland&apos;s premier sanctuary for aesthetic gynaecology. We unite <br className="hidden md:block" />
          scientific innovation with deeply personalized care.
        </motion.p>
        ...
        >
          ...
          <span className="text-[10px] font-bold uppercase tracking-widest text-zinc-900">About Academy</span>
        </motion.div>
      </div>
